...
#SBATCH --output="/Studies/CAP_Time_Analytics/cap_codes/slurm_output/St3_P100-%A_%a.out"
#SBATCH --array=1-1000
...
python $basedir/CAP_Time_Analytics/cap_codes/pyCAP/pyCAP/pycap_Ssplit_run_hcp_step3_trt.py \
--homedir $homedir \
--outdir $outdir \
--datadir $datadir \
