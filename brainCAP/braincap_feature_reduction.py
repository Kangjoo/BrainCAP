...
logging.info("BrainCAP Feature Reduction Start")
...
#OUTPUT
out_dir = os.path.join(args.analysis_folder, "feature_reduction")
os.makedirs(out_dir, exist_ok=True)
fig_dir = os.path.join(out_dir, "figures") #For figures from this step
os.makedirs(fig_dir, exist_ok=True)

out_path = os.path.join(out_dir, f"{args.tag}feature_reduction.hdf5") #If saving file per split, change to f"{args.tag}feature_reduction_split{sp}.hdf5"
