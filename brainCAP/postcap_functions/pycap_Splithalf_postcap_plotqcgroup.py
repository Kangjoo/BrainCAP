...
logging.basicConfig(level=logging.INFO,
                    ...
                    filename=filein.logdir + 'pycap_Splithalf_postcap_plotqcgroup.log',
                    filemode='w')
...
# ax = pt.RainCloud(x="seedthr", y="n_cap", hue="half", data=allpth_qc,
#                   palette=pal, bw=.2, width_viol=.5,
#                   ax=ax, orient="v", alpha=.85, dodge=True, move=.2)
