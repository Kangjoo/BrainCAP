...
parser.add_argument("--save_image", type=str, help="Save CAP images or not (y/n)")
parser.add_argument("--k_method", type=str, help="(sse/silhouette)")
...
#NEED FIX FOR DENSE 
parser.add_argument("--parc_template", type=file_path, required=False ,help="Path to parcellation template")
